                    ...
                    <div class="row w-100">
                        <div class="table-responsive">
                            <table class="table table-image">
                                <thead>
                                    <tr>
                                        <th style="vertical-align: middle; font-weight: bold; visibility: hidden;">ID</th>
                                        <th>Nome</th>
                                        <th>Email</th>
                                        <th>Assunto</th>
                                        <th>Mensagem</th>
                                ...
                                <tbody>
                                    <c:forEach items="${duvidas}" var="duvida">
                                        <tr>
                                            <td style="vertical-align: middle; font-weight: bold; visibility: hidden;">${duvida.id}</td>
                                            <td style="vertical-align: middle; font-weight: bold;">${duvida.nome}</td>
                                            <td style="vertical-align: middle;">${duvida.email}</td>
                                            <td style="vertical-align: middle;">${duvida.assunto}</td>
                                            <td style="vertical-align: middle; overflow: hidden; max-width: 200px; word-wrap: break-word;">${duvida.mensagem}</td>
                                            <td style="vertical-align: middle;">
                                                <div>
                                                <a href="DuvidaDelete?duvidaId=${duvida.id}">Deletar</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:forEach>
