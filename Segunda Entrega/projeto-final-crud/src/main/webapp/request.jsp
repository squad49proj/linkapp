                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-0 px-lg-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="navbar-nav fw-bold mx-auto py-0" style="font-size: 1rem;">
                            ...
                            <a href="request.jsp" class="nav-item nav-link active">REQUESTS</a>
                ...
                <section class="container">
                    ...
                    <form class="row g-3" action="---" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" name="equipamento" class="form-control" id="exampleFormControlInput1"
                                placeholder="Notebook, Tablet..">
                        </div>
                        <div class="mb-3">
                            <label for="inputEmail4" class="form-label">CPF de usuário</label>
                            <input type="email" name="cpf" class="form-control" id="inputEmail4"
                                placeholder="Email de usuário cadastrado">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Escreva seu relato:</label>
                            <textarea class="form-control" name="relato" id="exampleFormControlTextarea1"
                                rows="3"></textarea>
                            <br>
                ...
                <main>
                    <div class="container py-3">
                        <div class="card">
                            <div class="row ">
                                <div class="col-md-4">
                                    <img src="./img request/andre.jpg" class="w-100">
                                </div>
                                <div class="col-md-8 pb-4">
                                    <div class="card-block px-3">
                                        <br>
                                        <br>
                                        <h4 class="card-title">André Sales</h4>
                                        <p class="card-text">Olá, me chamo André Sales, tenho 28 anos e sou de São Paulo
                                            capital, ganhei uma bolsa de estudos para curso desenvolvimento de software,
                                            porém
                                            necessito de um notebook para estudar.</p>
                                        <br>
                ...
                <main>
                    <div class="container py-3">
                        <div class="card">
                            <div class="row ">
                                <div class="col-md-4">
                                    <img src="./img request/renata.jpg" class="w-100">
                                </div>
                                <div class="col-md-8 pb-4">
                                    <div class="card-block px-3">
                                        <br>
                                        <br>
                                        <h4 class="card-title">Renata Lima</h4>
                                        <p class="card-text">Oi, me chamo Renata Lima, sou do rio de janeiro, baixada
                                            fluminense, estudante de rede pública, meu sonho e aprender inglês, um
                                            tablet seria
                                            de grande ajuda.</p>
                                        <br>
                                        <a href="#" class="btn btn-primary">Doar</a>
                ...
                <main>
                    <div class="container py-3">
                        <div class="card">
                            <div class="row ">
                                <div class="col-md-4">
                                    <img src="./img request/thiago.jpg" class="w-100">
                                </div>
                                <div class="col-md-8 pb-4">
                                    <div class="card-block px-3">
                                        <br>
                                        <br>
                                        <h4 class="card-title">Thiago Gomes</h4>
                                        <p class="card-text">Me chamo Thiago, sou natural de Recife, necessito de um
                                            mouse e um
                                            teclado para dar continuidade a meus estudos.</p>
                                        <br>
                                        <a href="#" class="btn btn-primary">Doar</a>
                                    </div>
                                </div>
                ...
                <main>
                    <div class="container py-3">
                        <div class="card">
                            <div class="row ">
                                <div class="col-md-4">
                                    <img src="./img request/vanessa.jpg" class="w-100 h-100">
                                </div>
                                <div class="col-md-8 pb-4">
                                    <div class="card-block px-3">
                                        <br>
                                        <br>
                                        <h4 class="card-title">Vanessa Silva</h4>
                                        <p class="card-text">Sou Vanessa, tenho 18 anos, cursando o ultimo ano do ensino
                                            médio,
                                            e pretendo prestar vestibular para universidade federal, o cursinho e a
                                            distância, e
                                            seria de grande ajuda um notebook e ou tablet para conseguir fazer o curso.
                                        </p>
                                        <br>
                                        <a href="#" class="btn btn-primary">Doar</a>
                                        <br>
