                            ...
                            <table class="table table-image">
                                ...
                                <tbody>
                                    <c:forEach items="${doacoes}" var="doacao">
                                        <tr>
                                            <td style="vertical-align: middle; font-weight: bold; visibility: hidden;">${doacao.id}</td>
                                            <td style="vertical-align: middle; font-weight: bold;">${doacao.nome}</td>
                                            <td style="vertical-align: middle; overflow: hidden; max-width: 200px; word-wrap: break-word;">${doacao.email}</td>
                                            <td style="vertical-align: middle;">${doacao.quantia}</td>
                                            <td style="vertical-align: middle;">
                                                <div>
                                                <a href="DoacaoDelete?doacaoId=${doacao.id}">Deletar</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:forEach>
